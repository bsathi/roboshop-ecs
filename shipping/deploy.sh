#!/bin/bash
# Deploy Shipping service to ECS Fargate
# Usage: ENV=dev bash shipping/deploy.sh
...
echo "  DNS: shipping.roboshop.local:8080"
echo "  Depends on: cart.roboshop.local, mysql.roboshop.local"
echo "  NOTE: Java service — allow 60s startup before health checks pass"
