#!/bin/bash
# Deploy Cart service to ECS Fargate
# Usage: ENV=dev bash cart/deploy.sh
...
echo "  DNS: cart.roboshop.local:8080"
echo "  Depends on: redis.roboshop.local, catalogue.roboshop.local"
