#!/bin/bash
# Deploy Catalogue service to ECS Fargate
# Usage: ENV=dev bash catalogue/deploy.sh
...
echo "  DNS: catalogue.roboshop.local:8080"
echo "  Depends on: mongodb.roboshop.local"
