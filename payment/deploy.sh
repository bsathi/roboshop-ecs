#!/bin/bash
# Deploy Payment service to ECS Fargate
# Usage: ENV=dev bash payment/deploy.sh
...
echo "  DNS: payment.roboshop.local:8080"
echo "  Depends on: cart.roboshop.local, user.roboshop.local, rabbitmq.roboshop.local"
